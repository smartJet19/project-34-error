...
var star1, star2;
var starDisplay;
var starDisplayImg0,starDisplayImg1,starDisplayImg2
var balloon;
var starImg;
...
function preload()
{
  ...
  starDisplayImg0 = loadAnimation("empty.png")
  starDisplayImg1 = loadAnimation("one_star.png")
  starDisplayImg2 = loadAnimation("stars.png")
...
function setup() 
{
  ...
  starDisplay.addAnimation('empty',starDisplayImg0);
  starDisplay.addAnimation('one',starDisplayImg1);
  starDisplay.addAnimation('two',starDisplayImg2);
  starDisplay.changeAnimation('empty');

  star1 = createSprite(100,300,50,50)
  star1.scale =0.02
  star1.addAnimation('star',starImg)

  star2 = createSprite(40,800,50,50)
  star2.scale =0.02
  star2.addAnimation('star',starImg)
